...
import { getSentiment, getSentimentHistory, type SentimentPoint } from '@zenith/data'
 ...
 */
function Comparisons({ points }: { points: SentimentPoint[] }) {
          ...
          return (
            <div key={row.label} className="flex items-baseline justify-between gap-3 px-4 py-3">
              ...
              <dd className="flex shrink-0 items-baseline gap-3">
                <span className="text-xs text-ink-muted">{classify(row.point.value)}</span>
  ...
  return (
    <section className="max-w-2xl space-y-3" aria-labelledby="methode-titre">
      ...
      <p className="text-base leading-relaxed text-ink-muted">
        ...
        dominance du bitcoin et les tendances de recherche. ZENITH le relaie tel quel,
        sans le recalculer.
      </p>
