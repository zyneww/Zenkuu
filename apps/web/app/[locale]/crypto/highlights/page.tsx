    ...
    <div className="space-y-12 sm:space-y-16">
      ...
      <section className="space-y-5" aria-labelledby="nouveautes-titre">
        ...
        {recent.length > 0 && listings.ok ? (
          <>
            <ul className="grid grid-cols-1 gap-px overflow-hidden rounded-card border border-border-subtle bg-border-subtle sm:grid-cols-2 lg:grid-cols-5">
              {recent.map((item) => (
      ...
      <section className="space-y-5" aria-labelledby="secteurs-titre">
        ...
        {narratives.ok && narratives.data.length > 0 ? (
          <>
            <ul className="grid grid-cols-1 gap-px overflow-hidden rounded-card border border-border-subtle bg-border-subtle sm:grid-cols-2 lg:grid-cols-3">
