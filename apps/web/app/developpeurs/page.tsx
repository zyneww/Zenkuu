...
export const metadata: Metadata = {
  ...
  description:
    'Les routes internes de ZENITH, les sources de données publiques utilisées, et l’état réel d’une API publique ZENITH.',
    ...
    <div className="mx-auto max-w-3xl space-y-10 py-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-ink-muted">
          ZENITH ne produit aucune cotation. Si vous avez besoin de données brutes,
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-ink-muted">
          Les sources gratuites imposent des plafonds stricts, et ZENITH s’y astreint
