...
export const viSeo: SeoDescriptions = {
  ...
  '/nouvelles-cotations':
    'Những đồng tiền mã hoá được niêm yết gần đây nhất: giá, vốn hoá, khối lượng và ngày ghi nhận giá sớm nhất được biết.',
  '/perpetuels':
    'Các sàn hợp đồng vĩnh cửu xếp theo hợp đồng mở: mức phơi nhiễm đang gánh, khối lượng 24 giờ, vòng quay, số hợp đồng. Nền tảng phi tập trung và nền tảng lưu ký được tách riêng. ZENKUU không lưu sổ lệnh nào và không cho phép giao dịch.',
  '/places':
