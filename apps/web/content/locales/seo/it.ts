...
export const itSeo: SeoDescriptions = {
  ...
  '/nouvelles-cotations':
    'Le criptovalute quotate più di recente: prezzo, capitalizzazione, volume e data della prima rilevazione di prezzo nota.',
  '/perpetuels':
    'Le sedi di contratti perpetui ordinate per interesse aperto: esposizione portata, volume su 24 ore, rotazione, numero di contratti. Piattaforme decentralizzate e con custodia distinte. ZENKUU non riporta alcun libro ordini e non consente alcuna transazione.',
  '/places':
