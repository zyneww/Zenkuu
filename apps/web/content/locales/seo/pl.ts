...
export const plSeo: SeoDescriptions = {
  ...
  '/nouvelles-cotations':
    'Najnowiej notowane kryptowaluty: kurs, kapitalizacja, wolumen i data najwcześniejszego znanego odczytu ceny.',
  '/perpetuels':
    'Giełdy kontraktów wieczystych uszeregowane według otwartych pozycji: niesiona ekspozycja, wolumen z 24 godzin, rotacja, liczba kontraktów. Platformy zdecentralizowane i powiernicze wykazane osobno. ZENKUU nie prowadzi żadnej księgi zleceń i nie umożliwia żadnej transakcji.',
  '/places':
