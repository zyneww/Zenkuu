...
export const nlSeo: SeoDescriptions = {
  ...
  '/nouvelles-cotations':
    'De meest recent genoteerde cryptomunten: koers, marktkapitalisatie, volume en de datum van de vroegst bekende koersmeting.',
  '/perpetuels':
    'De platformen voor perpetuele contracten gerangschikt naar openstaande posities: gedragen blootstelling, volume over 24 uur, omloop, aantal contracten. Gedecentraliseerde en bewarende platformen apart getoond. ZENKUU voert geen orderboek en maakt geen enkele transactie mogelijk.',
  '/places':
