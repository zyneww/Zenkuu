 ...
 *
 * Règle de rédaction : ces articles décrivent ce que ZENITH FAIT RÉELLEMENT. Aucun
 ...
 *
 * Le libellé est « à lire en premier » et non « les plus consultés » : ZENITH ne
...
export const HELP_CATEGORIES: HelpCategory[] = [
    ...
    articles: [
      {
        ...
        body: [
          'ZENITH ne produit aucune donnée de marché. Le site interroge des sources publiques et affiche ce qu’elles publient, sans le retoucher.',
      ...
      },
      {
        ...
        body: [
          ...
          'ZENITH n’affiche pas de cours en temps réel, et ne le prétend pas. Les sources gratuites imposent des limites de requêtes strictes ; interroger en continu les dépasserait en quelques minutes et couperait l’accès pour tout le monde.',
      ...
      },
      {
        ...
        body: [
          'Quand une source ne publie pas une information, ZENITH affiche un état vide explicite au lieu de combler le trou. C’est une règle de conception, pas un défaut.',
      ...
      },
      {
        ...
        body: [
          'ZENITH affiche ce que la source publie. Un écart entre notre affichage et un autre site vient le plus souvent d’une source différente, d’une devise différente, ou d’un horodatage différent.',
    ...
    articles: [
      {
        ...
        title: 'À quoi sert un compte ZENITH',
        summary: 'À retrouver vos préférences — jamais à détenir des fonds.',
        body: [
          'Un compte ZENITH sert à conserver une liste de suivi et des préférences d’affichage d’un appareil à l’autre.',
          'Il ne donne accès à aucune fonction financière. ZENITH ne détient pas de fonds, ne connecte aucun portefeuille et n’exécute aucun ordre — un compte ne change rien à cela.',
      ...
      },
      {
        ...
        title: 'ZENITH ne demande aucune donnée bancaire',
        summary: 'Aucun formulaire du site ne collecte de coordonnées de paiement.',
        body: [
          'Aucune page de ZENITH ne demande de numéro de carte, de coordonnées bancaires ni de clé d’accès à une plateforme d’échange.',
          'Si une page se présentant comme ZENITH vous demande ces informations, elle n’est pas la nôtre.',
          'Nous ne demandons jamais non plus de clé d’API d’un exchange, ni d’accès en lecture à un portefeuille : ZENITH n’a aucun usage de ces informations.',
        ],
      },
    ],
  },
  {
    ...
    description: 'Ce que ZENITH ne fait pas, et pourquoi c’est délibéré.',
    icon: 'scale',
    articles: [
      {
        slug: 'ni-achat-ni-vente',
        title: 'Pourquoi ZENITH ne permet ni achat ni vente',
        summary: 'C’est un choix de positionnement, pas une fonctionnalité en retard.',
        body: [
          'ZENITH est une plateforme d’information en lecture seule. Il n’y a nulle part de bouton d’achat, de vente, de dépôt, de retrait ou de connexion à un portefeuille.',
      ...
      {
        slug: 'pas-de-conseil',
        title: 'ZENITH ne fournit aucun conseil en investissement',
        summary: 'Les indicateurs affichés sont descriptifs, pas prescriptifs.',
        body: [
          'Rien de ce qui est affiché sur ZENITH ne constitue une recommandation personnalisée d’achat, de vente ou de conservation.',
